...
TRANSLATIONS = {
    ...
    'it': {
        ...
        'subtitle': 'Ciao, nonna Ljuda! Spero che questo sito ti piaccia.',
    ...
    'en': {
        ...
        'subtitle': 'Hello, Grandma Lyuda! I hope you like this website.',
